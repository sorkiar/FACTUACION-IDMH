-- Catalog 20 SUNAT: Transfer reasons (motivos de traslado)
...
INSERT INTO transfer_reason (code, name, status) VALUES
    ...
    ('05', 'Consignación', 0),
    ('06', 'Devolución', 1),
    ('07', 'Recojo de bienes transformados', 0),
    ('08', 'Importación', 0),
    ('09', 'Exportación', 0),
    ('13', 'Otros', 1),
...
-- Add FK column to remission_guide
...
-- Migrate existing rows: map frontend enum names to catalog IDs
